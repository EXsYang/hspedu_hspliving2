...
public class SpuInfoController {
    ...
    public R list(@RequestParam Map<String, Object> params){
        // PageUtils page = spuInfoService.queryPage(params); //不带检索条件的
        PageUtils page = spuInfoService.queryPageByCondition(params); //带检索条件的
     ...
     * 保存
     * 解读:
     * 1. 因为我们保存的商品信息，涉及到的表非常多，不是SpuInfoEntity实体类可以全部包含的
     * 2. 因此，将 SpuInfoEntity 改成 我们前面生成的 SpuSaveVO 对象，将前端提交的json对象，全部封装到该对象
     * 3. 然后在下面的业务中，进行拆解/相应的保存
     */
    @RequestMapping("/save")
